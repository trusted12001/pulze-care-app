                        ...
                        @forelse($serviceUsers as $su)
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ $loop->iteration + ($serviceUsers->firstItem() - 1) }}
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="text-sm sm:text-base font-medium text-gray-900">{{ $su->full_name }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm sm:text-base text-gray-900">
                                        {{ optional($su->date_of_birth)->format('d M Y') ?: '—' }}
                                    </div>
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button type="button"
                                            onclick="showDeleteModal({{ $su->id }}, '{{ addslashes($su->full_name) }}')"
                                ...
                                <div class="flex items-start justify-between gap-2 mb-2">
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="text-xs text-gray-500 mt-0.5">
                                            {{ optional($su->date_of_birth)->format('d M Y') ?: '—' }}</p>
                                    </div>
                                    <span
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                <h3 class="text-lg leading-6 font-semibold text-gray-900" id="modal-title">Delete Service
                                    User</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Are you sure you want to move this service user to
                                        recycle bin?</p>
