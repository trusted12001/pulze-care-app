          ...
          @forelse($serviceUsers as $su)
            ...
            <tr class="hover:bg-gray-50 border-t">
              ...
              <td class="px-4 py-2 text-right space-x-2">
                <a href="{{ route('backend.admin.service-users.profile', $su) }}" class="text-sm font-bold text-green-700 hover:underline">Open</a>
...
<script>
  (function () {
    ...
    input.addEventListener('keyup', function () {
      ...
      const rows = document.querySelectorAll('#suTable tbody tr');
      rows.forEach(row => {
