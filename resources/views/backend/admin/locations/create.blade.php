  ...
  <div class="max-w-4xl mx-auto py-4 sm:py-6 lg:py-8 px-3 sm:px-4 lg:px-6">
    ...
    <div class="mb-6 sm:mb-8">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        <div>
          <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Add Location</h1>
          <p class="text-sm sm:text-base text-gray-600">Create a new location</p>
        </div>
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      <div class="px-4 sm:px-5 lg:px-6 py-4 bg-gradient-to-r from-gray-50 to-slate-50 border-b border-gray-200">
        <h2 class="text-lg sm:text-xl font-semibold text-gray-900 flex items-center gap-2">
          <i class="ph ph-map-pin text-gray-600"></i>
          <span>Location Information</span>
        </h2>
      </div>

      <form method="POST" action="{{ route('backend.admin.locations.store') }}" class="p-4 sm:p-5 lg:p-6">
        @csrf
