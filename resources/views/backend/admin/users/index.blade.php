...
<div class="min-h-screen p-0 rounded-lg">
  ...
  <div class="bg-white p-6 rounded-lg shadow-md mb-8 border border-gray-200">
    <form method="POST" action="{{ route('backend.admin.users.store') }}">
      @csrf
        ...
        <div class="md:col-span-2">
          ...
          <select name="role" required
            ...
            @foreach($roles as $role)
              @if(in_array($role->name, ['admin', 'carer'])) {{-- limit roles --}}
        ...
        <tbody class="text-sm text-gray-700">
          ...
          <tr class="hover:bg-gray-50 border-t">
            ...
            <td class="px-4 py-2 text-right space-x-2">
              ...
              <form action="{{ route('backend.admin.users.destroy', $user->id) }}"
          ...
          @empty
          <tr>
            <td colspan="6" class="text-center px-4 py-6 text-gray-500">No staff found.</td>
          </tr>
          @endforelse
        </tbody>
      </table>
