...
@section('content')
  ...
  <body>
    ...
    <main class="home-screen position-absolute top-0 start-0 end-0">
            ...
            <div class="d-flex justify-content-between align-items-start gap-4">
              <div class="d-flex justify-content-start align-items-start gap-4">
                <div class="doctor-img flex-center">
                  <img
                    src="{{ asset('assets/img/top-doctor-1.png')}}"
                    class="h-100"
                    alt=""
                  />
                  <img src="{{ asset('assets/img/active.png')}}" class="active" alt="" />
                </div>
                <div class="">
          ...
          <div class="w-100 top-doctor-item p-4">
            <div class="d-flex justify-content-between align-items-start gap-4">
              <div class="d-flex justify-content-start align-items-start gap-4">
                <div class="doctor-img flex-center">
                  <img
                    src="{{ asset('assets/img/top-doctor-2.png')}}"
                    class="h-100"
                    alt=""
                  />
                  <img src="{{ asset('assets/img/active.png')}}" class="active" alt="" />
          ...
          <div class="w-100 top-doctor-item p-4">
            <div class="d-flex justify-content-between align-items-start gap-2">
              <div class="d-flex justify-content-start align-items-start gap-4">
                <div class="doctor-img flex-center">
                  <img
                    src="{{ asset('assets/img/top-doctor-3.png')}}"
                    class="h-100"
                    alt=""
                  />
                  <img src="{{ asset('assets/img/active.png')}}" class="active" alt="" />
          ...
          <div class="w-100 top-doctor-item p-4">
            <div class="d-flex justify-content-between align-items-start gap-4">
              <div class="d-flex justify-content-start align-items-start gap-4">
                <div class="doctor-img flex-center">
                  <img
                    src="{{ asset('assets/img/top-doctor-4.png')}}"
                    class="h-100"
                    alt=""
                  />
                  <img src="{{ asset('assets/img/active.png')}}" class="active" alt="" />
        ...
        <div class="row doctor-speciality g-4">
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-6.png')}}" alt="" />
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-2.png')}}" alt="" />
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-3.png')}}" alt="" />
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-4.png')}}" alt="" />
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-5.png')}}" alt="" />
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-7.png')}}" alt="" />
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-8.png')}}" alt="" />
              <p class="title">Location</p>
              <a href="#" class="d-inline-flex align-items-center gap-1"
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-9.png')}}" alt="" />
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="{{ asset('assets/img/docton-speciality-icon-10.png')}}" alt="" />
              <p class="title">Surgeon</p>
              <a href="#" class="d-inline-flex align-items-center gap-1"
                >120 doctors <i class="ph ph-arrow-right"></i
              ></a>
