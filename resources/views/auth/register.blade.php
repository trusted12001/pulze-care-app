            ...
            <div class="bg-white/90 backdrop-blur-sm border border-gray-200 shadow-sm rounded-2xl overflow-hidden">
                <div class="px-6 pt-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600"><span class="font-bold">Create account</span> to access your care tools</p>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="px-6 pb-6 pt-2 space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Use at least 8 characters, including a number and a symbol.</p>
                        @error('password')
                            <p class="form-error text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <p class="text-center text-sm text-gray-600">
                        Already registered?
                        <a href="{{ route('login') }}" class="text-orange-700 hover:text-orange-800 font-medium">Sign in</a>
                    </p>
                </form>
            </div>
