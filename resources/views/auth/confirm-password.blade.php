            ...
            <div class="bg-white/90 backdrop-blur-sm border border-gray-200 shadow-sm rounded-2xl overflow-hidden">
                <div class="px-6 pt-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl sm:text-2xl font-bold text-green-900">Confirm Password</h1>
                            <p class="text-sm text-gray-600">Secure area — please confirm your password</p>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="px-6 pb-6 pt-2 space-y-4">
                    @csrf
                    ...
                    @if (Route::has('password.request'))
                        <p class="text-center text-sm text-gray-600">
                            ...
                            <a href="{{ route('password.request') }}" class="text-orange-700 hover:text-orange-800 font-medium">Reset it here</a>
                        </p>
                    @endif
                </form>
            </div>
