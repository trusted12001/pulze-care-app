...
{
    protected $fillable = ['location_id','start_date','end_date','status','generated_by','published_at'];
    protected $casts = ['start_date'=>'date','end_date'=>'date','published_at'=>'datetime'];
