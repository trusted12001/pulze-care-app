...
class ServiceUser extends Model
{
    ...
    protected $fillable = [
        ...
        'nhs_number','national_insurance_no',
        'photo_path',
        'primary_phone','secondary_phone','email',
        'address_line1','address_line2','city','county','postcode','country',
        'placement_type','location_id','room_number',
        'admission_date','expected_discharge_date','discharge_date',
        'status','funding_type','funding_authority','purchase_order_ref','weekly_rate',
        'primary_diagnosis','other_diagnoses','allergies_summary','diet_type','intolerances',
        'mobility_status','communication_needs',
        ...
        'fall_risk','choking_risk','pressure_ulcer_risk','wander_elopement_risk',
        'safeguarding_flag','infection_control_flag','smoking_status','capacity_status',
        'consent_obtained_at','dnacpr_status','dnacpr_review_date','dols_in_place','dols_approval_date',
        'lpa_health_welfare','lpa_finance_property','advanced_decision_note',
        'ethnicity','religion','primary_language','interpreter_required',
        'personal_preferences','food_preferences',
        'gp_practice_name','gp_contact_name','gp_phone','gp_email','gp_address',
